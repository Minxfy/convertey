...
export default function AuthDebug() {
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-black text-white p-4 rounded text-xs max-w-sm">
      ...
      {authState.sessionError && <div className="text-red-300">Session Error: {authState.sessionError}</div>}
      {authState.userError && <div className="text-red-300">User Error: {authState.userError}</div>}
